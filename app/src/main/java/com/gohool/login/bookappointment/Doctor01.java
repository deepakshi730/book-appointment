...
public class Doctor01 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor01);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Doctor01.this, "Back", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(Doctor01.this, Doctor.class);
                startActivity(i);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        Doctor01.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(Doctor01.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
